...
urlpatterns = [
    ...
    path("admin/toggle-visibility/<int:product_id>/", views.toggle_product_visibility, name="toggle_product_visibility"),
    ...
    path("api/state/", views.store_state_api, name="store_state_api"),
